...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2?
   ...
   counter2 has to scope out to access let count = 0, while counter1 doesn't have to.

  2. Which of the two uses a closure? How can you tell?

  // counter1 uses closure because it returns a function whithin a function. Example of that was when it used const counter1 = counterMaker(); and in the function you see it return function counter(){ return count++;}.

  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  

counter2 would be better if you are trying to access it globally, meaning all the functions have access to it. Unlike counter1 which would be better if you are only trying to have one function to access it.
*/
...
function scoreboard(inningScoreCB, inningCB, numInnings) {
  ...
  if(homeScore === awayScore){
    ...
    scoreByInning.push(`Final Score: Away
